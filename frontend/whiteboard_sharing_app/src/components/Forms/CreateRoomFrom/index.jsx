        ...
        <div>
            ...
            <form id="create-room-form">
                ...
                <div className="button-row">
                    <button type="button" className="btn btn-danger" onClick={()=>setRoomId(uuid())}>Generate Code</button>
                    <button type="button" className="btn btn-success" onClick={copyCode}>Copy Code</button>
                </div>
                <button type="submit" className="btn btn-primary" onClick={handleCreateRoom}>Create Room</button>
            </form>
        </div>
    );
};
